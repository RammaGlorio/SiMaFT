...
class CreateSuratKeluarSkProposalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('surat_keluar_sk_proposals', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('surat_keluar_sk_proposals');
    }
}
