...
namespace App\Http\Livewire\Arsip\SuratKeluar\KartuMahasiswa;
...
class Index extends Component
{
    ...
    {
        $daftar_surat = SuratKeluarKartuMahasiswa::where('status_selesai', 'selesai')
                                                ->where(function($q){
        ...
        return view('livewire.arsip.surat-keluar.kartu-mahasiswa.index', [
