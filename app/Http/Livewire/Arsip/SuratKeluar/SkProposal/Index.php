...
namespace App\Http\Livewire\Arsip\SuratKeluar\SkProposal;
...
class Index extends Component
{
    ...
    {
        $daftar_surat = SuratKeluarSkProposal::where('status_selesai', 'selesai')
                                                ->where(function($q){
        ...
        return view('livewire.arsip.surat-keluar.sk-proposal.index', [
