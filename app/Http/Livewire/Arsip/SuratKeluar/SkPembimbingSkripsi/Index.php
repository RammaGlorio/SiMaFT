...
namespace App\Http\Livewire\Arsip\SuratKeluar\SkPembimbingSkripsi;
...
class Index extends Component
{
    ...
    {
        $daftar_surat = SuratKeluarSkPembimbingSkripsi::where('status_selesai', 'selesai')
                                                        ->where(function($q){
        ...
        return view('livewire.arsip.surat-keluar.sk-pembimbing-skripsi.index', [
