...
namespace App\Http\Livewire\SuratMasukUmum\Pendidikan;
...
class Index extends Component
{
    ...
    {
        $daftar_surat = SuratMasukUmum::where('status', 'pendidikan')
        ...
        return view('livewire.surat-masuk-umum.pendidikan.index', [
