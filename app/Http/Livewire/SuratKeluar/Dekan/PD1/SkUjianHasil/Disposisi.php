...
namespace App\Http\Livewire\SuratKeluar\Dekan\PD1\SkUjianHasil;
...
class Disposisi extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->data_surat = SuratKeluarSkUjianHasil::where('id', $id)->where('status', 'dekan')->first();
    ...
    public function kirim()
    {
        ...
        try {
            ...
            if($this->data_surat->status !== 'dekan'){
                ...
                return redirect()->route('surat-keluar.pd1.dekan.sk-ujian-hasil.index');
            }
    ...
    {
        return view('livewire.surat-keluar.dekan.p-d1.sk-ujian-hasil.disposisi');
    }
}
