...
class Disposisi extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->data_surat = SuratKeluarSkProposal::where('id', $id)->where('status', 'dekan')->first();
    ...
    public function kirim()
    {
        ...
        try {
            ...
            if($this->data_surat->status !== 'dekan'){
                ...
                return redirect()->route('surat-keluar.pd1.dekan.sk-proposal.index');
            }
    ...
    {
        return view('livewire.surat-keluar.dekan.p-d1.sk-proposal.disposisi');
    }
}
