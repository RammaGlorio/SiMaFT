...
namespace App\Http\Livewire\SuratKeluar\PD1\SkProposal;
...
class Disposisi extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->data_surat = SuratKeluarSkProposal::where('id', $id)->where('status', 'pd1')->first();
    ...
    public function kirim()
    {
        ...
        try {
            ...
            if($this->data_surat->status !== 'pd1'){
                ...
                return redirect()->route('surat-keluar.pd1.sk-proposal.index');
            }
    ...
    {
        return view('livewire.surat-keluar.p-d1.sk-proposal.disposisi');
    }
}
