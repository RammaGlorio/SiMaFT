...
{
    public $suratId, $nama_mhs, $nim, $jurusan_prodi, $memperhatikan, $tanggal_surat, $sekertaris, $judul_skripsi;
    public $nama_dosen, $daftar_dosen_penguji = [];

    public function mount($id)
    {
        $dataSurat = SuratKeluarSkProposal::find($id);
    ...
    public function update()
    {
        ...
        try {
            if($this->suratId) {
                ...
                $dataSurat = SuratKeluarSkProposal::find($this->suratId);
    ...
    {
        return view('livewire.surat-keluar.pendidikan.sk-proposal.edit');
    }
}
