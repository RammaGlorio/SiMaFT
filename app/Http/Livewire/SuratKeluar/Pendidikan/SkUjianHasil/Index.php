...
class Index extends Component
{
    ...
    public $data_surat_masuk, $id_surat, $nama_mhs, $nim, $jurusan_prodi, $memperhatikan, $tanggal_surat, $judul_skripsi, $sekertaris, $wakil_sekertaris;
    ...
    {
        $this->data_surat_masuk = SuratMasukUmum::where('jenis_surat', 'sk_ujian_hasil')
                                                ->where('status', 'pendidikan')   
                                                ->whereDoesntHave('skUjianHasil')
    ...
    public function simpan_kirim($id)
    {
        ...
        try {
            $data_surat = SuratKeluarSkUjianHasil::where('id', $id)->where('status', 'pendidikan')->first();
    ...
    public function store()
    {
        ...
        try {
            $suratMasuk = SuratKeluarSkUjianHasil::create([
    ...
    {
        $daftar_surat = SuratKeluarSkUjianHasil::where('status', 'pendidikan')
        ...
        return view('livewire.surat-keluar.pendidikan.sk-ujian-hasil.index', [
