...
namespace App\Http\Livewire\SuratKeluar\Kabag\SkUjianHasil;
...
class Disposisi extends Component
{
    ...
    public function mount($id)
    {
        ...
        $this->data_surat = SuratKeluarSkUjianHasil::where('id', $id)->where('status', 'kabag')->first();
    ...
    public function kirim()
    {
        ...
        try {
            ...
            if($this->data_surat->status !== 'kabag'){
                ...
                return redirect()->route('surat-keluar.kabag.sk-ujian-hasil.index');
            }
    ...
    {
        return view('livewire.surat-keluar.kabag.sk-ujian-hasil.disposisi');
    }
}
