...
namespace App\Http\Livewire\SuratKeluar\Umum\SkUjianHasil;
...
class Index extends Component
{
    ...
    {
        try {
            $this->data_surat = SuratKeluarSkUjianHasil::find($id);
    ...
    public function simpan_no_surat()
    {
        ...
        $this->validate(
            [
                'no_surat' => 'required|unique:surat_keluar_sk_ujian_hasils,nomor_surat,'.$this->data_surat->id,
            ],
            [
    ...
    {
        $daftar_surat = SuratKeluarSkUjianHasil::where('status', 'umum')
        ...
        return view('livewire.surat-keluar.umum.sk-ujian-hasil.index', [
