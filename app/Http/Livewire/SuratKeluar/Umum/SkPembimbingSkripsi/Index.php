...
namespace App\Http\Livewire\SuratKeluar\Umum\SkPembimbingSkripsi;
...
class Index extends Component
{
    ...
    {
        try {
            $this->data_surat = SuratKeluarSkPembimbingSkripsi::find($id);
    ...
    public function simpan_no_surat()
    {
        ...
        $this->validate(
            [
                'no_surat' => 'required|unique:surat_keluar_sk_pembimbing_skripsis,nomor_surat,'.$this->data_surat->id,
            ],
            [
    ...
    {
        $daftar_surat = SuratKeluarSkPembimbingSkripsi::where('status', 'umum')
        ...
        return view('livewire.surat-keluar.umum.sk-pembimbing-skripsi.index', [
