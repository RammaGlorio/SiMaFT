...
namespace App\Http\Livewire\SuratKeluar\Umum\KartuMahasiswa;
...
class Index extends Component
{
    ...
    {
        try {
            $this->data_surat = SuratKeluarKartuMahasiswa::find($id);
    ...
    public function simpan_no_surat()
    {
        ...
        $this->validate(
            [
                'no_surat' => 'required|unique:surat_keluar_kartu_mahasiswas,nomor_surat,'.$this->data_surat->id,
            ],
            [
    ...
    {
        $daftar_surat = SuratKeluarKartuMahasiswa::where('status', 'umum')
        ...
        return view('livewire.surat-keluar.umum.kartu-mahasiswa.index', [
