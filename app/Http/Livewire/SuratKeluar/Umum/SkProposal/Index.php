...
namespace App\Http\Livewire\SuratKeluar\Umum\SkProposal;
...
class Index extends Component
{
    ...
    {
        try {
            $this->data_surat = SuratKeluarSkProposal::find($id);
    ...
    public function simpan_no_surat()
    {
        ...
        $this->validate(
            [
                'no_surat' => 'required|unique:surat_keluar_sk_proposals,nomor_surat,'.$this->data_surat->id,
            ],
            [
    ...
    {
        $daftar_surat = SuratKeluarSkProposal::where('status', 'umum')
        ...
        return view('livewire.surat-keluar.umum.sk-proposal.index', [
