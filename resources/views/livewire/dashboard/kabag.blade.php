    ...
    <div class="row">
        ...
        <!-- small box -->
            <div class="small-box bg-success">
                <div class="inner">
                    <h3>{{$total_surat_keluar_sk_pembimbing_skripsi+$total_surat_keluar_sk_proposal+$total_surat_keluar_sk_ujian_hasil+$total_surat_keluar_sk_kompre}}</h3>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered" style="margin-bottom: 5px">
                    <tbody>     
                        @if($total_surat_keluar_sk_pembimbing_skripsi <= 0 && $total_surat_keluar_sk_proposal <= 0 && $total_surat_keluar_sk_ujian_hasil <= 0 && $total_surat_keluar_sk_kompre <= 0)
                            <tr>
                                <th class="text-center" style="font-weight: normal" colspan="5">Tidak tersedia.</th>
                            </tr>  
                        @else
