                    ...
                    <div class="card-body">
                        <form wire:submit.prevent="store">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" wire:model="tanggal_ujian" class="form-control @error('tanggal_ujian') is-invalid @enderror" placeholder="Masukkan Tanggal Ujian">
                                @error('tanggal_ujian')
                                    <span class="invalid-feedback">
                                            {{ $message }}
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="waktu_ujian" class="form-control @error('waktu_ujian') is-invalid @enderror" placeholder="Masukkan Waktu Ujian">
                                @error('waktu_ujian')
                                    <span class="invalid-feedback">
                                            {{ $message }}
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" wire:model="tempat_ujian" class="form-control @error('tempat_ujian') is-invalid @enderror" placeholder="Masukkan Tempat Ujian">
                                @error('tempat_ujian')
                                    <span class="invalid-feedback">
                                            {{ $message }}
                                    </span>
                            ...
                            <div class="form-group">
                                <label>Wakil Sekertaris</label>
                                <input type="text" wire:model="wakil_sekertaris" class="form-control @error('wakil_sekertaris') is-invalid @enderror" placeholder="Masukkan Wakil Sekertaris">
                                @error('wakil_sekertaris')
                                    <span class="invalid-feedback">
                                        {{ $message }}
                                    </span>
                                @enderror
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank" href="{{ route('sk-komprehensif', $data->id) }}" class="btn btn-sm btn-primary">LIHAT</a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('surat-keluar.pendidikan.sk-komprehensif.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
