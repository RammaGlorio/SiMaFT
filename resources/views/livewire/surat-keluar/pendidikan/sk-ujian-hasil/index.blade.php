                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a target="_blank" href="{{ route('sk-ujian-hasil', $data->id) }}" class="btn btn-sm btn-primary">LIHAT</a>
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ route('surat-keluar.pendidikan.sk-ujian-hasil.edit', $data->id) }}" class="btn btn-sm btn-primary">EDIT</a>
