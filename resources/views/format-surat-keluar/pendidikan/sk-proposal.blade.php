...
<body>
    <div id=halaman>
        ...
        <div style="line-height: 3px; text-align : center; font-size: 14px; font-weight: bold; text-transform: uppercase">
            <p>PENUNJUKAN DAN PENGANGKATAN DOSEN PENGUJI PROPOSAL</p>
            ...
            <tr style="vertical-align: top">
                ...
                <td style="width: 84%; font-size: 11px">
                    <ol style="margin-top: 0">
                        <li>Bahwa untuk membimbing dan mengarahkan dalam rangka Ujian Proposal mahasiswa Program S1, 
                            {{ $surat_keluar?->jurusan_prodi ? $surat_keluar->jurusan_prodi : "....." }} FT UNIMA, perlu menunjuk dan mengangkat Dosen Penguji;</li>
                        <li>Bahwa nama yang tersebut pada lajur lampiran Surat Keputusan ini memenuhi syarat untuk diangkat selaku
                            Dosen Penguji ProposaL mahasiswa yang tersebut namanya pada lajur 1 dan 2 daftar lampiran Surat Keputusan
                            ini;</li>
        ...
        <div style="line-height: 3px; text-align : center; font-size: 14px; font-weight: bold">
            <p>SUSUNAN PANITIA PELAKSANA UJIAN PROPOSAL</p>
            ...
            <tr style="vertical-align: top">
                ...
                <td style="">
                    <ol style="margin-left: -20px">
                        <li>Rita Mangare, SE / Kabag Umum</li>
                        <li>Meike Supit, SE / Pranata Komputer Ahli Muda</li>
                        <li>Risky Karundeng / Staf Pengelola Pendidikan</li>
                        <li>Elisabeth A. Sumilat, ST / Staf Pengelola Pendidikan</li>
                        <li>Jensy Palandeng / Staf Pengelola Pendidikan</li>
                    </ol>
                </td>
            </tr>
        </table>
        ...
        <div style="line-height: 3px; text-align : center; font-size: 14px; font-weight: bold; text-transform: uppercase">
            <p>NAMA - NAMA DOSEN PENGUJI UJIAN PROPOSAL</p>
            <p>A. N. {{ $surat_keluar?->nama_mhs ? $surat_keluar->nama_mhs : "....."  }}, NIM. {{ $surat_keluar?->nim ? $surat_keluar->nim : "....." }}, MAHASISWA PROGRAM S1 </p>
            <p>{{ $surat_keluar?->jurusan_prodi ? $surat_keluar->jurusan_prodi : "....." }} FT UNIMA</p>
        </div>
